/***********************************************************************************
 * Name			: student_class.cpp
 * Author		: bpatton
 * Date			: September 7, 2018
 * Description 	: Displays student information taken as input.
...
/*
 * fing_failing_students()
 * 		Returns a vector of failing students (those whose gpa is < 1.0).
 */
